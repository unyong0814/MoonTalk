package com.moonstudio.voltex.moontalk.fragment;
...
public class SelectFreindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_freind);
    ...
    class SelectFriendRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private class CustomViewHolder extends RecyclerView.ViewHolder {
            ...
            public CustomViewHolder(View view) {
                ...
                chechBox = (CheckBox)view.findViewById(R.id.frienditem_checkbox);
            }
        }
    }
}
